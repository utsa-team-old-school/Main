...
void PIT_IRQHandler()
{
	...
	//These 4 lines added to get the X position on Pot 0
	GPIOB_PDDR |=  ((uint32_t) (1<<8))	| ((uint32_t) (1<<9)) ;
	GPIOB_PDDR &=  ~(((uint32_t) (1<<10)) | ((uint32_t) (1<<11)));
	GPIOB_PSOR |=  ((uint32_t) (1<<8)) | ((uint32_t) (1<<10));
	GPIOB_PCOR |=  ((uint32_t) (1<<9))|((uint32_t) (1<<11));
...
void ADC0_IRQHandler()
{
	...
	switch(CurrentADC_State)
	{
		...
		case ADC_STATE_CAPTURE_POT_0:
				...
				//These 4 lines added to set Tilt Table up to get Y position
				GPIOB_PDDR &=  ~(((uint32_t) (1<<8)) | ((uint32_t) (1<<9))) ;
				GPIOB_PDDR |=  ((uint32_t) (1<<10)) | ((uint32_t) (1<<11));
				GPIOB_PSOR |=  (uint32_t) (1<<10);
				GPIOB_PCOR |=  ((uint32_t) (1<<11)) | ((uint32_t) (1<<8))	| ((uint32_t) (1<<9));
		...
		case ADC_STATE_CAPTURE_POT_1:
				...
				// These 4 lines added to get X pos from Tilt Table
				GPIOB_PDDR |=  ((uint32_t) (1<<8))	| ((uint32_t) (1<<9)) ;
				GPIOB_PDDR &=  ~(((uint32_t) (1<<10)) | ((uint32_t) (1<<11)));
				GPIOB_PSOR |=  ((uint32_t) (1<<8)) | ((uint32_t) (1<<10));
				GPIOB_PCOR |=  ((uint32_t) (1<<9))|((uint32_t) (1<<11));
