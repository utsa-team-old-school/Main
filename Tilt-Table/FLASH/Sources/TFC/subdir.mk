...
Sources/TFC/Get_XY.o: ../Sources/TFC/Get_XY.c
	...
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/TFC/Get_XY.args" -Wa,-adhlns="$@.lst" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/TFC/Get_XY.o"
